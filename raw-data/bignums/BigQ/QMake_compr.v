...
Ltac custom_tac39 H0 H1 H2 := intros H0 H1; rewrite <- H2.

Ltac custom_tac88 H0 H1 := auto; unfold H0, H1.

Ltac custom_tac51 H0 H1 := apply H0; apply H1.

Ltac custom_tac24 H0 := rewrite H0; qsimpl.

Ltac custom_tac86 H0 H1 := destruct irred as ( n1,d1); destruct irred as ( n2,d2); simpl @snd in *; destruct H0 as [ Hg1 Hg2]; destruct H1 as [ Hg1' Hg2'].

Ltac custom_tac87 H0 := auto with zarith; rewrite H0 in *.

Ltac custom_tac79 H0 H1 := auto with zarith; rewrite H0 in H1.
