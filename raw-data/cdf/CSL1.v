...
- inv H. rename c' into c''. rename h' into h''. destruct b as [cc hh].
  edestruct safe_red as (h1' & hj' & A & B & C & D).
  eassumption. eassumption. assumption. assumption.
  subst hh. eapply IHn; eauto.
Qed.
...
- constructor; auto.
  ...
  + intros. inv H2. exists h, hj; intuition auto.
    ...
    * apply TR; auto.
    * intros. destruct n' as [|]. constructor. apply safe_ifthenelse.
      ** intros. destruct n' as [|]; constructor. split; auto.
