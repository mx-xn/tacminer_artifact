...
- intros a1 (a2 & S12 & X2). inversion S12. subst a.
  + destruct (H a2 X2) as (a3 & P23 & X3). inversion P23. subst a c.
...
+ subst a0 c1. assert (b = b0) by (eapply R_functional; eauto). subst b0.
  apply IHstar; auto.
Qed.
