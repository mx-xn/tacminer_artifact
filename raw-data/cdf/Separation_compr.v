...
Lemma sepconj_self: forall P,
  precise P ->
  P ** P -->> P. Proof. intros. intros h (h1 & h2 & P1 & P2 & D & E). assert (h1 = h2). apply H with h2 h1; auto. HDISJ. apply hunion_comm; HDISJ. subst h2. assert (h = h1). apply heap_extensionality; intros l. rewrite E; cbn. destruct (h1 l) as [z|]; auto. congruence. Qed.
