...
Proof.
  intros. inversion H; clear H; subst. auto. contradiction.
Qed.
...
Proof.
  induction n; intros.
- inversion H; clear H; subst. exists h1, hj; auto.
- inversion H; clear H; subst. rename c' into c''. rename h' into h''. destruct b as [c' h'].
...
- intros ST; inversion ST; clear ST; subst.
- eauto.
Qed.
...
- destruct n' as [ | n']. constructor. inversion H; clear H; subst.
  + constructor; auto.
...
- intros. intro ST; inversion ST; clear ST; subst.
...
- intros. inversion H2; clear H2; subst.
  apply star_starN in H4. destruct H4 as (N & STEPS).
  rewrite <- hunion_assoc in STEPS. rewrite <- (hunion_empty hf) in STEPS.
  edestruct safe_redN as (h1' & hj' & A & B & C & D).
  eexact STEPS.
...
- constructor; auto; intros.
  ...
  + red; intros. inversion H2; clear H2; subst. eelim safe_not_erroneous; eauto.
  + subst h0. inversion H2; clear H2; subst.
...
- intro ST; inversion ST; clear ST; subst.
- inversion H4; clear H4; subst. exists h, hj; intuition auto. destruct (Z.eqb_spec b 0); auto.
Qed.
...
- constructor; auto.
  + intros; intro ST. inversion ST; clear ST; subst.
  + intros. inversion H2; clear H2; subst. exists h, hj; intuition auto.
...
- cbn; intros. destruct H as [H | H]; eapply safe_immacc in H; eauto.
  ...
  destruct (h1 l); congruence.
- intros. intros ST; inversion ST; clear ST; subst.
  ...
  + elim (safe_not_erroneous _ _ _ _ _ hj (hunion h1 hf) S2).
    ...
    rewrite hunion_assoc in H3. rewrite <- (hunion_comm hj) by HDISJ.
    rewrite hunion_assoc. rewrite (hunion_comm hj) by HDISJ. assumption.
- intros; subst h. inversion H2; clear H2; subst.
...
- intros. subst h0. intro ST; inversion ST; clear ST; subst. cbn in H2. rewrite L in H2. congruence.
- intros. subst h0. inversion H2; clear H2; subst.
  assert (v0 = v).
...
Proof.
  ...
  destruct n; constructor; auto.
- cbn; intros. congruence.
- intros; intro ST; inversion ST; clear ST; subst. cbn in H3. rewrite L in H3; congruence.
- intros. subst h0. rewrite Ph in H. inversion H2; clear H2; subst.
...
Proof.
  ...
  destruct n; constructor; auto.
- intros; intro ST. inversion ST; clear ST; subst.
- intros. rewrite hunion_empty in H0. subst h. inversion H2; clear H2; subst.
...
- constructor.
- inversion S; clear S; subst; inversion S'; clear S'; subst.
