...
let list2tree l =
  ...
  Section RMAX_np.
    ...
    Proof.
      ...
      - intro e; elim e; custom_tac3.
      - intro d; case d; intro H'.
          + custom_tac3. 
          + custom_tac56 R1 H1 H2 H3 H4 H5 H6. 
 ...
 (RM n t t') if t' is a search tree obtained by removing n from t *)
  ...
  Proof.
    custom_tac42 rm_intro; auto with searchtrees. 
