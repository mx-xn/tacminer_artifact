...
Proof.
intros; [destruct H as [P']; [destruct H as [Q']; [destruct H as [CPP' H]; [destruct H as [CQQ' S]; [unfold lts_cong; [exists P'; [exists Q'; [repeat split; [eauto|eauto|clear CPP'; [clear CQQ'; [induction S; [eapply lts_comp_left; [eapply IHS]|eapply lts_comm_left; [constructor|constructor]]]]]]]]]]]]].
Qed.
...
Proof.
intros; [destruct H as [R]; [destruct H; [unfold early_bisimilar; [exists R; [split; [eauto|unfold early_bisimulation in H; [destruct H; [apply H; [apply H0]]]]]]]]].
Qed.

Theorem early_bisimilarity_refl :
  forall p, early_bisimilar p p.
Proof.
intros; [unfold early_bisimilar; [exists (fun p q => p = q); [split; [unfold early_bisimulation; [split; [eauto|intros; [subst; [eauto]]]]|eauto]]]].
Qed.

Theorem early_bisimilarity_trans :
  forall p q r, early_bisimilar p q -> early_bisimilar q r -> early_bisimilar p r.
Proof.
intros; [unfold early_bisimilar in *; [destruct H as [R1];
[destruct H0 as [R2]; [destruct H; [destruct H0;
[exists (clos_trans process (fun p q => (R1 p q \/ R2 p q))); [split; [unfold early_bisimulation in *; [split; [intros; [induction H3; [destruct H3; [eapply t_step; [left; [apply H; [eauto]]]|eapply t_step; [right; [apply H0; [eauto]]]]|eapply t_trans; [eapply IHclos_trans2|eapply IHclos_trans1]]]|intros; [generalize dependent P1'; [induction H3; [destruct H3; [destruct H; [intros; [eapply H4 in H5; [destruct H5; [exists x0; [split; [destruct H5; [apply H5]|eapply t_step; [destruct H5; [left; [apply H6]]]]]]|apply H3]]]|intros; [eapply H0 in H4; [destruct H4; [destruct H4; [exists x0; [split; [apply H4|eapply t_step; [right; [apply H5]]]]]]|apply H3]]]|intros; [apply IHclos_trans1 in H4; [destruct H4; [destruct H3; [apply IHclos_trans2 in H3; [destruct H3; [destruct H3; [exists x1; [split; [apply H3|eapply t_trans; [apply H4|apply H5]]]]]]]]]]]]]]]|eapply t_trans; [eapply t_step; [left; [apply H1]]|eapply t_step; [right; [apply H2]]]]]]]]]]].
Qed.
...
Theorem progresses_subset_left :
  forall R S T, subset R S -> progresses S T ->
                progresses R T.
Proof.
intros; [unfold progresses in *; [repeat split; [destruct H0; [intros; [eapply H0 in H2; [destruct H2 as [Q'0]; [exists Q'0; [split; [eapply H2|eapply H2]]]|apply H; [apply H3]]]]|destruct H0; [intros; [eapply H1 in H2; [destruct H2 as [Q'0]; [exists Q'0; [eapply H2]]|apply H; [apply H3]]]]]]].
Qed.
...
Theorem progresses_subset_right :
  forall R S T, subset S T -> progresses R S ->
                progresses R T.
Proof.
intros; [unfold progresses in *; [repeat split; [destruct H0; [intros; [eapply H0 in H2; [destruct H2 as [P']; [exists P'; [split; [eapply H2|eapply H; [eapply H2]]]]|eapply H3]]]|destruct H0; [intros; [eapply H1 in H2; [destruct H2 as [Q']; [exists Q'; [split; [eapply H2|eapply H; [eapply H2]]]]|eapply H3]]]]]].
Qed.
...
Proof.
intros; [induction n; [simpl; [eauto]|simpl; [unfold symmetric; [intros; [destruct H1; [left; [eauto]|right; [eauto; [eapply H0 in IHn; [eauto]]]]]]]]].
Qed.
...
Proof.
intros; [unfold progresses; [repeat split; [intros; [destruct H as [H _]; [destruct H0 as [H0 _]; [destruct H2; [eapply H in H1; [apply H1|apply H2]|eapply H0 in H1; [apply H1|apply H2]]]]]|intros; [destruct H as [_ H]; [destruct H0 as [_ H0]; [destruct H2; [eapply H in H1; [eapply H1|apply H2]|eapply H0 in H1; [eapply H1|apply H2]]]]]]]].
Qed.
...
Proof.
intros; [induction n; [simpl; [eapply progresses_subset_right; [unfold subset; [intros; [eauto]]|apply H0]]|simpl in *; [eapply progresses_union; [eapply progresses_subset_right; [unfold subset; [intros; [left; [apply H1]]]|apply IHn]|eapply progresses_subset_right with (F (fun P Q => apply_n n R F P Q \/ F (apply_n n R F) P Q)); [unfold subset; [intros; [right; [eauto]]]|eapply H in IHn; [apply IHn|unfold subset; [intros; [left; [eauto]]]]]]]]].
Qed.
...
Proof.
intros; [generalize dependent P; [induction n; [intros; [simpl; [simpl in H; [exists A; [eauto]]]]|intros; [simpl; [simpl in H; [simpl in IHn; [inversion H; [exists x; [split; [eapply H1|eapply IHn; [eapply H1]]]]]]]]]]].
Qed.
...
Proof.
intros; [destruct H; [destruct H0; [exists (1 + x + x0); [eapply iterate_sum; [eapply H|eapply H0]]]]].
Qed.
...
Proof.
intros; [generalize dependent R; [generalize dependent S; [induction n; [intros; [split; [simpl; [unfold closure; [unfold subset; [intros; [eapply H0; [eauto|eauto|eauto]]]]]|simpl; [unfold closure; [unfold progresses; [split; [intros; [eapply H0 in H1; [eapply H1; [eapply H3|eapply H4]|eauto]]|intros; [eapply H0 in H1; [eapply H1; [eapply H3|eapply H4]|eauto]]]]]]]]|intros; [split; [unfold subset; [simpl; [intros; [destruct H3 as [A]; [destruct H3; [assert (progresses R S); [eauto|apply IHn in H2; [destruct H2 as [H2 H2']; [eapply H2 in H4; [eapply H0 in H1; [destruct H1; [eapply H1 in H3; [destruct H3 as [n']; [destruct H4 as [n'']; [exists (1 + (n' + n'')); [eapply iterate_sum; [eauto|eauto]]]]]]|eauto]]]|eauto]]]]]]]|split; [intros; [simpl in H4; [destruct H4 as [A]; [destruct H4; [assert (subset R S); [eauto|eapply IHn in H6; [assert (subset R S); [eauto|eapply H0 in H7; [destruct H7; [destruct H8 as [H8 _]; [destruct H6 as [_ H6]; [destruct H6 as [H6 _]; [eapply H6 in H5; [destruct H5; [destruct H5; [eapply H8 in H4; [destruct H4; [destruct H4; [exists x0; [split; [eapply H4|eapply closure_compose; [eapply H10|eapply H9]]]]]|eapply H5]]]|eapply H3]]]]]|eauto]]|eauto]]]]]]|intros; [simpl in H4; [destruct H4 as [A]; [destruct H4; [assert (subset R S); [eauto|eapply IHn in H6; [assert (subset R S); [eauto|eapply H0 in H7; [destruct H7; [destruct H8 as [_ H8]; [destruct H6 as [_ H6]; [destruct H6 as [_ H6]; [eapply H8 in H4; [destruct H4; [destruct H4; [eapply H6 in H5; [destruct H5; [destruct H5; [exists x0; [split; [eapply H5|eapply closure_compose; [eapply H9|eapply H10]]]]]|eapply H4]]]|eapply H3]]]]]|eauto]]|eauto]]]]]]]]]]]]].
Qed.
...
Proof.
intros; [unfold closure; [unfold strongly_safe; [intros; [split; [unfold subset; [intros; [destruct H3 as [n]; [eapply iterate_progresses; [eauto|eauto|eauto|eauto|eauto]]]]|unfold progresses; [split; [intros; [destruct H4; [eapply iterate_progresses in H1; [eapply H1; [eauto|eauto]|eauto|eauto|eauto]]]|intros; [destruct H4; [eapply iterate_progresses in H1; [eapply H1; [eauto|eauto]|eauto|eauto|eauto]]]]]]]]]].
Qed.
...
Proof.
intros; [induction nc1; [simpl; [rewrite IHnc1; [eauto]]|simpl; [rewrite IHnc1; [eauto]]|simpl; [rewrite IHnc1; [eauto]]|simpl; [rewrite IHnc1; [eauto]]|simpl; [eauto]]].
Qed.
...
Proof.
intros; [generalize dependent l; [generalize dependent P'; [induction C; [intros; [simpl in *; [inversion H1; [subst; [exists (ni_fill C Q); [split; [constructor|exists 0; [simpl; [exists C; [exists P; [exists Q; [repeat split; [eapply H; [eapply H2]]]]]]]]]]]]]|intros; [simpl in *; [inversion H1; [subst; [eapply IHC in H4; [destruct H4 as [Q']; [destruct H3; [exists (compose Q' (replicate (ni_fill C Q))); [split; [eapply lts_rep_act; [eapply H3]|destruct H4; [exists (1 + x); [simpl; [exists (compose P'0 (replicate (ni_fill C Q))); [split; [exists (ni_compose_r P'0 (ni_replicate C)); [exists P; [exists Q; [repeat split; [eauto]]]]|apply ni_context_helper with (C := (ni_compose_l ni_hole (replicate (ni_fill C Q)))) in H4; [eapply H4]]]]]]]]]]]]|subst; [eapply IHC in H4; [eapply IHC in H5; [destruct H4; [destruct H3; [destruct H5; [destruct H5; [exists (compose (compose x x0) (replicate (ni_fill C Q))); [split; [eapply lts_rep_comm; [eapply H3|eapply H5]|destruct H4 as [m]; [destruct H6 as [m'']; [exists (2 + m + m''); [simpl; [exists (compose (compose P'0 P'') (replicate (ni_fill C Q))); [split; [exists (ni_compose_r (compose P'0 P'') (ni_replicate C)); [exists P; [exists Q; [repeat split; [eauto]]]]|eapply iterate_sum; [apply ni_context_helper with (C := (ni_compose_l (ni_compose_l ni_hole P'') (replicate (ni_fill C Q)))) in H4; [eapply H4]|simpl; [apply ni_context_helper with (C := (ni_compose_l (ni_compose_r x ni_hole) (replicate (ni_fill C Q)))) in H6; [eapply H6]]]]]]]]]]]]]]]]]]]]]|intros; [inversion H1; [subst; [eapply IHC in H7; [destruct H7; [destruct H3; [exists (compose x p); [split; [simpl; [eapply lts_comp_left; [eapply H3]]|destruct H4; [exists (x0); [apply ni_context_helper with (C := (ni_compose_l ni_hole p)) in H4; [eapply H4]]]]]]]]]|subst; [simpl in *; [exists (compose (ni_fill C Q) Q'); [split; [eapply lts_comp_right; [eapply H7]|exists 0; [simpl; [exists (ni_compose_l C Q'); [exists P; [exists Q; [repeat split; [eauto]]]]]]]]]]|subst; [eapply IHC in H5; [destruct H5 as [Q0]; [destruct H3; [simpl; [exists (compose Q0 Q'); [split; [eapply lts_comm_left; [eapply H3|eapply H8]|destruct H4; [exists x; [apply ni_context_helper with (C := ni_compose_l ni_hole Q') in H4; [eapply H4]]]]]]]]]]|subst; [eapply IHC in H5; [destruct H5 as [Q0]; [destruct H3; [simpl; [exists (compose Q0 Q'); [split; [eapply lts_comm_right; [eauto|eauto]|destruct H4 as [n']; [exists n'; [apply ni_context_helper with (C := ni_compose_l ni_hole Q') in H4; [eapply H4]]]]]]]]]]]]|intros; [inversion H1; [subst; [simpl in *; [exists (compose P'0 (ni_fill C Q)); [split; [eapply lts_comp_left; [eapply H7]|exists 0; [simpl; [exists (ni_compose_r P'0 C); [exists P; [exists Q; [repeat split; [eauto]]]]]]]]]]|subst; [eapply IHC in H7; [destruct H7; [destruct H3; [exists (compose p x); [split; [simpl; [eapply lts_comp_right; [eapply H3]]|destruct H4; [exists (x0); [apply ni_context_helper with (C := (ni_compose_r p ni_hole)) in H4; [eapply H4]]]]]]]]]|subst; [eapply IHC in H8; [destruct H8 as [Q0]; [destruct H3; [simpl; [exists (compose P'0 Q0); [split; [eapply lts_comm_left; [eapply H5|eapply H3]|destruct H4; [exists x; [apply ni_context_helper with (C := ni_compose_r P'0 ni_hole) in H4; [eapply H4]]]]]]]]]]|subst; [eapply IHC in H8; [destruct H8 as [Q0]; [destruct H3; [simpl; [exists (compose P'0 Q0); [split; [eapply lts_comm_right; [eauto|eauto]|destruct H4 as [n']; [exists n'; [apply ni_context_helper with (C := ni_compose_r P'0 ni_hole) in H4; [eapply H4]]]]]]]]]]]]|intros; [simpl in *; [eapply H0 in H1; [destruct H1 as [Q']; [exists Q'; [split; [eapply H1|exists 0; [simpl; [exists ni_hole; [simpl; [exists P'; [exists Q'; [repeat split; [eauto; [eapply H1]]]]]]]]]]]|eauto]]]]]]].
Qed.
