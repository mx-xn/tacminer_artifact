...
Proof.
split with 1 0; [auto | auto|auto | .. ].
Qed.

Lemma b_n : forall a b : nat, bezout a b -> bezout (a + b)%nat b.
Proof.
intros a b H; [case H; [intros u v H0 HA e; [split with u ( v - u ); [lia |auto with arith |rewrite inj_plus; [ring_simplify; [auto | .. ] | .. ] | .. ] | .. ] | .. ] | .. ].
Qed.

Lemma b_d : forall a b : nat, bezout a b -> bezout a (a + b)%nat.
Proof.
intros a b H; [case H; [intros u v H0 HA e; [split with ( u - v ) v; [auto with arith |auto with arith |rewrite inj_plus; [ring_simplify; [now rewrite ( Zmult_comm v ( Z_of_nat b ) ) | .. ] | .. ] | .. ] | .. ] | .. ] | .. ].
Qed.
...
Proof.
simple induction f; [simpl; [split; [auto | .. ] | .. ] |simpl; [intro f0; [case ( fraction f0 ); [inversion_clear 1; [split; [auto | .. ] | .. ] | .. ] | .. ] | .. ] |simpl; [intro f0; [case ( fraction f0 ); [inversion_clear 1; [split; [auto | .. ] | .. ] | .. ] | .. ] | .. ] | .. ].
Qed.