...
Proof.
cofix COH; [intros; [unroll_delay (bind_aux d s); [destruct d; [destruct (f a0 (safe_inv_now Q a0 s)) as (d1 & s1); [cbn; [constructor; [auto]]]|constructor; [apply COH]]]]].
Qed.
...
Program Definition consequence_post
  ...
  fun p => m p.
Next Obligation.
destruct (m p); [cbn; [apply safe_consequence with Q; [auto|auto]]].
Qed.
...
Proof.
cofix COINDHYP; [intros; [unroll_delay (iter_aux d s); [destruct d as [[a | b] | d]; [destruct f as [ab' s']; [constructor; [apply COINDHYP]]|apply safe_inv_now in s; [constructor; [auto]]|constructor; [apply COINDHYP]]]]].
Qed.
...
Next Obligation.
split; [destruct p as (h1 & h2 & p1 & p2 & D & U); [rewrite U in Heq_anonymous; [cbn in Heq_anonymous; [rewrite ! p1, hupdate_same in Heq_anonymous; [congruence]]]]|auto].
Qed.
Next Obligation.
exfalso; [destruct p as (h1 & h2 & p1 & p2 & D & U); [rewrite U in Heq_anonymous; [cbn in Heq_anonymous; [rewrite ! p1, hupdate_same in Heq_anonymous; [congruence]]]]].
Qed.
...
Next Obligation.
destruct p as (h1 & h2 & p1 & p2 & D & U); [destruct p1 as (v0 & p1); [rewrite p1 in *; [exists (hupdate l v hempty), h2; [split; [red; [auto]|split; [auto|split; [red; [intros x; [cbn; [specialize (D x); [cbn in D; [destruct (Z.eq_dec l x); [intuition congruence|intuition]]]]]]|rewrite U; [apply heap_extensionality; [intros x; [cbn; [destruct (Z.eq_dec l x); [auto|intuition]]]]]]]]]]]].
Qed.
