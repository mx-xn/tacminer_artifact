...
Proof.
intros; [destruct n; [constructor|constructor; [auto]]].
Qed.
...
Proof.
induction n; [intros; [inv H; [exists h1, hj; [auto]]]|intros; [inv H; [rename c' into c''; [rename h' into h''; [destruct b as [c' h']; [edestruct safe_red as (h1' & hj' & A & B & C & D); [eassumption|eassumption|assumption|assumption|subst h'; [eapply IHn; [eauto|auto|auto|auto]]]]]]]]].
Qed.
...
Proof.
intros; [inv H; [intros ST; [inv ST]|eauto]].
Qed.
...
Lemma safe_immacc: forall n c h1 Q J l,
  ...
  h1 l <> None.
Proof.
intros; [inv H; [contradiction|eapply ACC; [auto]]].
Qed.

Lemma safe_mono: forall n c h Q J,
  safe n c h Q J -> forall n', (n' <= n)%nat -> safe n' c h Q J.
Proof.
induction n; [intros; [replace n' with O by lia; [constructor]]|destruct n' as [| n']; [constructor|inv H; [constructor; [auto]|constructor; [auto|auto|auto|auto; [intros; [edestruct STEP as (h1' & hj' & A & B & C & D); [eauto|eauto|eauto|eauto|exists h1', hj'; [intuition]]]]]]]].
Qed.
...
Lemma triple_frame: forall J P c Q R,
  ...
  J ⊢ ⦃ P ** R ⦄ c ⦃ fun v => Q v ** R ⦄.
Proof.
intros; [red; [intros; [destruct H0 as (h1 & h2 & P1 & R2 & D & U); [subst h; [apply safe_frame; [auto|auto|auto]]]]]].
Qed.
...
Lemma safe_frame_invariant:
  ...
  safe n c h Q (J ** J').
Proof.
induction n; [intros; [constructor]|intros; [inv H; [constructor; [auto]|constructor; [auto|auto|intros; [destruct H1 as (hj1 & hj2 & A & B & C & D); [subst hj h0; [apply (IMM (hunion hj2 hf) hj1); [HDISJ|f_equal; [rewrite hunion_assoc; [auto]]|auto]]]]|intros; [destruct H1 as (hj1 & hj2 & A & B & C & D); [subst hj h0; [edestruct (STEP (hunion hj2 hf) hj1) as (h1' & hj1' & U & V & X & Y); [HDISJ|eauto|auto|rewrite <- (hunion_assoc hj1) by HDISJ; [eauto]|subst h'; [exists h1', (hunion hj1' hj2); [split; [HDISJ|split; [f_equal; [rewrite hunion_assoc; [auto]]|split; [exists hj1', hj2; [intuition auto; [HDISJ]]|apply IHn; [auto]]]]]]]]]]]]]].
Qed.
...
Proof.
induction n; [intros; [constructor]|intros; [inv H; [constructor; [exists h, h'; [auto]]|constructor; [auto|intros; [apply ACC in H; [cbn; [destruct (h l); [congruence|congruence]]]]|intros; [apply (IMM hf (hunion h' hj)); [HDISJ|subst h0; [rewrite ! hunion_assoc; [auto]]|rewrite hunion_comm by HDISJ; [exists hj, h'; [intuition auto; [HDISJ]]]]]|intros; [edestruct (STEP hf (hunion h' hj)) as (h1' & hj' & U & V & X & Y); [HDISJ|subst h0; [rewrite ! hunion_assoc; [auto]]|rewrite hunion_comm by HDISJ; [exists hj, h'; [intuition auto; [HDISJ]]]|rewrite <- hunion_assoc  by HDISJ; [subst h0; [eauto]]|destruct X as (hj1' & hj2' & A & B & C & D); [subst hj' h'0 h0; [exists (hunion h1' hj2'), hj1'; [split; [HDISJ|split; [rewrite (hunion_comm hj2') by HDISJ; [rewrite ! hunion_assoc; [auto]]|split; [auto|apply IHn; [auto|HDISJ|auto]]]]]]]]]]]]].
Qed.
...
Lemma triple_share: forall J J' P c Q,
  ...
  J ⊢ ⦃ P ** J' ⦄ c ⦃ fun v => Q v ** J' ⦄.
Proof.
intros; [intros n h (h1 & h2 & Ph1 & J'h2 & D & U); [subst h; [apply safe_share; [auto|auto|auto]]]].
Qed.
...
Proof.
induction n; [intros until h; [intros S1 S2; [constructor]]|intros until h; [intros S1 S2; [constructor; [auto|intros; [eapply safe_immacc; [eauto|eauto]]|red; [intros; [inv H2; [eelim safe_not_erroneous; [eauto|eauto|eauto|eauto]]]]|intros; [subst h0; [inv H2; [exists h, hj; [intuition auto; [apply S2; [eapply safe_pure_inv; [eauto]|lia]]]|edestruct safe_red as (h1' & hj' & A & B & C & D); [eauto|eauto|auto|auto|exists h1', hj'; [intuition auto]]]]]]]]].
Qed.
...
Lemma triple_let:
  ...
  J ⊢ ⦃ P ⦄ LET c f ⦃ R ⦄.
Proof.
intros; [red; [intros; [apply safe_let with Q; [apply H; [auto]|intros; [apply H0; [auto]]]]]].
Qed.
...
Corollary triple_seq:
  ...
  J ⊢ ⦃ P ⦄ SEQ c1 c2 ⦃ R ⦄.
Proof.
intros; [apply triple_let with (fun _ => Q); [auto|auto]].
Qed.
...
Proof.
intros; [constructor; [auto|auto|intros; [intro ST; [inv ST]]|intros; [inv H4; [exists h, hj; [intuition auto; [destruct (Z.eqb_spec b 0); [auto|auto]]]]]]].
Qed.
...
Proof.
intros; [red; [intros; [destruct n; [constructor|apply safe_ifthenelse; [intros; [apply H; [split; [auto|auto]]]|intros; [apply H0; [split; [auto|auto]]]]]]]].
Qed.
...
Proof.
intros J P c Q TR IMP; [red; [induction n; [intros h Ph; [constructor]|intros h Ph; [constructor; [auto|auto|intros; [intro ST; [inv ST]]|intros; [inv H2; [exists h, hj; [intuition auto; [apply safe_let with Q; [apply TR; [auto]|intros; [destruct n'; [constructor|apply safe_ifthenelse; [intros; [destruct n'; [constructor|constructor; [split; [auto|auto]]]]|intros; [apply safe_mono with n; [apply IHn; [apply IMP; [congruence]]|lia]]]]]]]]]]]]]]].
Qed.
...
Proof.
induction n; [intros until h2; [intros S1 S2 DISJ; [constructor]]|intros until h2; [intros S1 S2 DISJ; [constructor; [auto|cbn; [intros; [destruct H as [H | H]; [eapply safe_immacc in H; [instantiate (1 := h1) in H; [destruct (h1 l); [congruence|eauto]]|eauto]|eapply safe_immacc in H; [instantiate (1 := h2) in H; [destruct (h1 l); [congruence|eauto]]|eauto]]]]|intros; [intros ST; [inv ST; [destruct H3 as [IM1 IM2]; [eapply safe_immacc in IM1; [instantiate (1 := h1) in IM1; [eapply safe_immacc in IM2; [instantiate (1 := h2) in IM2; [specialize (DISJ l); [tauto]]|eauto]]|eauto]]|elim (safe_not_erroneous _ _ _ _ _ hj (hunion h2 hf) S1); [HDISJ|auto|rewrite hunion_assoc in H3; [rewrite <- (hunion_comm hj) by HDISJ; [rewrite hunion_assoc; [rewrite (hunion_comm hj) by HDISJ; [assumption]]]]]|elim (safe_not_erroneous _ _ _ _ _ hj (hunion h1 hf) S2); [HDISJ|auto|rewrite <- (hunion_comm h1) in H3 by HDISJ; [rewrite hunion_assoc in H3; [rewrite <- (hunion_comm hj) by HDISJ; [rewrite hunion_assoc; [rewrite (hunion_comm hj) by HDISJ; [assumption]]]]]]]]]|intros; [subst h; [inv H2; [apply safe_pure_inv in S1; [apply safe_pure_inv in S2; [exists (hunion h1 h2), hj; [intuition auto; [apply safe_pure; [exists h1, h2; [intuition auto]]]]]]|rewrite hunion_assoc in H3; [rewrite <- (hunion_comm h2) in H3 by HDISJ; [rewrite hunion_assoc in H3; [destruct (safe_red _ _ _ _ _ _ _ _ _ H3 S1) as (h1' & hj' & A & B & C & D); [auto|HDISJ|subst h'; [exists (hunion h1' h2), hj'; [split; [HDISJ|split; [rewrite hunion_assoc; [f_equal; [rewrite <- (hunion_comm h2) by HDISJ; [rewrite hunion_assoc; [auto]]]]|split; [assumption|apply IHn; [auto|apply safe_mono with (S n); [auto|auto]|HDISJ]]]]]]]]]]|rewrite <- (hunion_comm h1) in H3 by HDISJ; [rewrite hunion_assoc in H3; [rewrite <- (hunion_comm h1) in H3 by HDISJ; [rewrite hunion_assoc in H3; [destruct (safe_red _ _ _ _ _ _ _ _ _ H3 S2) as (h2' & hj' & A & B & C & D); [auto|HDISJ|subst h'; [exists (hunion h2' h1), hj'; [split; [HDISJ|split; [rewrite hunion_assoc; [f_equal; [rewrite <- (hunion_comm h1) by HDISJ; [rewrite hunion_assoc; [auto]]]]|split; [assumption|rewrite hunion_comm by HDISJ; [apply IHn; [apply safe_mono with (S n); [auto|auto]|HDISJ; [auto]|HDISJ]]]]]]]]]]]]]]]]]]].
Qed.
...
Proof.
intros until Q2; [intros TR1 TR2 n h Ph; [destruct Ph as (h1 & h2 & Ph1 & Ph2 & D & U); [subst h; [apply safe_par; [auto|auto|auto]]]]].
Qed.
...
Proof.
intros J l v n h Ph; [assert (L: h l = Some v) by (rewrite Ph; apply hupdate_same); [destruct n; [constructor|constructor; [auto|cbn; [intros; [congruence]]|intros; [subst h0; [intro ST; [inv ST; [cbn in H2; [rewrite L in H2; [congruence]]]]]]|intros; [subst h0; [inv H2; [assert (v0 = v); [cbn in H3; [rewrite L in H3; [congruence]]|subst v0; [exists h, hj; [intuition auto; [apply safe_pure; [split; [auto|auto]]]]]]]]]]]]].
Qed.

Lemma triple_set: forall J l v,
  J ⊢ ⦃ valid l ⦄ SET l v ⦃ fun _ => contains l v ⦄.
Proof.
intros J l v n h Ph; [destruct Ph as (v0 & Ph); [assert (L: h l = Some v0) by (rewrite Ph; apply hupdate_same); [destruct n;
  [constructor
  |constructor;
    [auto
    |cbn; [intros; [congruence]]
    |intros; [intro ST; [inv ST; [cbn in H3; [rewrite L in H3; [congruence]]]]]
    |intros; [subst h0; [rewrite Ph in H; [inv H2; [ exists (hupdate l v hempty), hj;
    [intuition auto]]]]]]]]]].
      HDISJ;
        [red; [intros l0; [generalize (H l0); [cbn; [destruct (Z.eq_dec l l0);
          [intuition congruence
          |intuition congruence]]]]]
        |red; [intros l0; [generalize (H0 l0); [cbn; [destruct (Z.eq_dec l l0);
          [intuition congruence
          |intuition congruence]]]]]].
      rewrite Ph; [apply heap_extensionality; [intros l0; [cbn; [destruct (Z.eq_dec l l0);
        [auto|auto]]]]].
...
Proof.
induction sz as [| sz]; [intros l; [cbn; [red; [auto]]]|intros l; [cbn; [exists (hupdate l 0 hempty), (hinit (l + 1) sz hempty); [split; [exists 0; [red; [auto]]|split; [apply IHsz|split; [intros x; [unfold hupdate, hempty at 1; [cbn; [destruct (Z.eq_dec l x); [right; [rewrite hinit_outside by lia; [auto]]|auto]]]]|apply heap_extensionality; [intros x; [cbn; [destruct (Z.eq_dec l x); [auto|auto]]]]]]]]]]].
Qed.
...
[destruct n;
  ...
  |constructor;
    ...
    |intros; [rewrite hunion_empty in H0; [subst h; [inv H2; [exists (hinit l sz hempty), hj; [intuition auto;
      ...
      apply safe_pure; [split;
        [auto | apply valid_N_init]].
Qed.

Lemma triple_free: forall J l,
  J ⊢ ⦃ valid l ⦄ FREE l ⦃ fun _ => emp ⦄.
Proof.
intros J l n h Ph; [destruct Ph as (v0 & Ph); [assert (L: h l = Some v0) by (rewrite Ph; apply hupdate_same); [destruct n;
  [constructor
  |constructor;
    [auto
    |cbn; [intros; [congruence]]
    |intros; [intro ST; [inv ST; [cbn in H3; [rewrite L in H3; [congruence]]]]]
    |intros; [subst h0; [rewrite Ph in H; [inv H2; [exists hempty, hj; [intuition auto]]]]]]]]]].
    HDISJ.
    assert (D: hdisjoint (hupdate l v0 hempty) (hunion hj hf)) by HDISJ;
      [rewrite Ph;
      [apply heap_extensionality; [intros l0; [cbn;
      [destruct (Z.eq_dec l l0);
        [subst l0; [destruct (D l);
...
Lemma safe_consequence:
  ...
  safe n c h Q J.
Proof.
induction n; [intros; [constructor]|intros; [inv H0; [constructor; [apply H; [auto]]|constructor; [auto|auto|auto|intros; [edestruct STEP as (h1' & hj' & A & B & C & D); [eauto|eauto|auto|eauto|exists h1', hj'; [intuition auto]]]]]]].
Qed.
...
Lemma triple_consequence_post:
  ...
  J ⊢ ⦃ P ⦄ c ⦃ Q ⦄.
Proof.
intros; [intros n h Ph; [apply safe_consequence with Q'; [auto|auto]]].
Qed.
...
Lemma triple_simple_conj_pre: forall J (P1: Prop) P2 c Q,
  ...
  J ⊢ ⦃ P1 //\\ P2 ⦄ c ⦃ Q ⦄.
Proof.
intros; [intros n h Ph; [destruct Ph; [apply H; [auto|auto]]]].
Qed.
...
Proof.
intros until Q'; [intros TR1 TR2 n h [Ph | P'h]; [apply safe_consequence with Q; [intros v1 h1; [red; [auto]]|apply TR1; [auto]]|apply safe_consequence with Q'; [intros v1 h1; [red; [auto]]|apply TR2; [auto]]]].
Qed.
...
Proof.
induction n; [intros c h S S'; [constructor]|intros c h S S'; [inv S; [inv S'; [constructor; [split; [auto|auto]]|contradiction]|inv S'; [contradiction|constructor; [auto|auto|auto|intros; [edestruct STEP as (h1' & hj' & D' & E' & J' & SAFE'); [eauto|eauto|auto|eauto|edestruct STEP0 as (h1'' & hj'' & D'' & E'' & J'' & SAFE''); [eauto|eauto|auto|eauto|assert (hj' = hj''); [apply H with (hunion h1' hf) (hunion h1'' hf); [HDISJ|HDISJ|rewrite ! (hunion_comm hf) by HDISJ; [rewrite <- ! hunion_assoc; [rewrite (hunion_comm h1'), (hunion_comm h1'') by HDISJ; [congruence]]]|auto|auto]|subst hj''; [assert (h1' = h1''); [apply hunion_invert_l with (hunion hj' hf); [congruence|HDISJ|HDISJ]|subst h1''; [exists h1', hj'; [auto]]]]]]]]]]]]].
Qed.
...
Proof.
intros until Q'; [intros PR TR1 TR2 n h (Ph & P'h); [apply safe_and; [auto|auto|auto]]].
Qed.
...
Proof.
intros; [apply triple_consequence_post with (Q' := fun v => (v <> 0) //\\ (if Z.eqb v 0 then emp else R)); [apply triple_repeat; [apply triple_swap|rewrite Z.eqb_refl; [red; [auto]]]|intros v h [H1 H2]; [apply Z.eqb_neq in H1; [rewrite H1 in H2; [auto]]]]].
Qed.
...
Proof.
intros; [apply triple_atomic; [rewrite sepconj_comm; [unfold sem_invariant at 1; [rewrite lift_aexists; [apply triple_exists_pre; [intros v; [rewrite sepconj_assoc; [apply triple_consequence_post with (Q' := fun _ => contains lck 1 ** (if v =? 0 then emp else R) ** R); [apply triple_frame; [apply triple_consequence_pre with (valid lck); [apply triple_set|red; [intros; [exists v; [auto]]]]]|intros; [intros h P; [assert ((contains lck 1 ** R) h); [eapply sepconj_imp_r; [instantiate (1 := ((if v =? 0 then emp else R) ** R)); [destruct (v =? 0); [rewrite sepconj_emp; [red; [auto]]|apply sepconj_self; [auto]]]|auto]|rewrite sepconj_emp; [exists 1; [simpl; [auto]]]]]]]]]]]]]]].
Qed.
...
Proof.
intros; [set (Qloop := fun p => if p =? 0 then emp else aexists (fun x => contains p x ** valid (p + 1) ** R x)); [apply triple_consequence_post with (fun p => (p <> 0) //\\ Qloop p); [apply triple_repeat; [apply triple_atomic; [rewrite sepconj_emp; [apply triple_exists_pre; [intros l; [apply triple_exists_pre; [intros p; [eapply triple_let; [apply triple_frame; [apply triple_get]|cbn; [intros p'; [rewrite lift_pureconj; [apply triple_simple_conj_pre; [intros E; [subst p'; [apply triple_ifthenelse; [apply triple_simple_conj_pre; [intros NOTZERO; [rewrite sepconj_comm; [destruct l as [| x l]; [cbn; [rewrite lift_pureconj; [apply triple_simple_conj_pre; [intro; [try lia]]]]|cbn; [rewrite lift_pureconj; [apply triple_simple_conj_pre; [intro; [rewrite lift_aexists; [apply triple_exists_pre; [intros t; [eapply triple_let; [rewrite ! sepconj_assoc, sepconj_pick2; [apply triple_frame; [apply triple_get]]|intros t'; [cbn; [rewrite lift_pureconj; [apply triple_simple_conj_pre; [intros E; [subst t'; [rewrite <- ! sepconj_assoc, sepconj_comm, ! sepconj_assoc; [eapply triple_seq; [apply triple_frame with (Q := fun _ => contains buff t); [eapply triple_consequence_pre; [apply triple_set|intros h A; [exists p; [auto]]]]|apply triple_pure; [unfold Qloop; [apply Z.eqb_neq in NOTZERO; [rewrite NOTZERO; [rewrite (sepconj_pick2 (contains p x)); [rewrite <- (sepconj_pick3 (contains buff t)); [rewrite <- (sepconj_pick2 (contains buff t)); [intros h A; [rewrite lift_aexists; [exists x; [rewrite ! sepconj_assoc; [eapply sepconj_imp_r; [instantiate (1 := (contains (p + 1) t ** R x ** contains buff t ** list_invariant R l t)); [intros h' B; [apply sepconj_imp_l with (P := contains (p + 1) t); [intros h'' C; [exists t; [auto]]|revert h' B; [apply sepconj_imp_r; [apply sepconj_imp_r; [intros h''' D; [red; [exists l; [exists t; [auto]]]]]]]]]]|eauto]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]|apply triple_simple_conj_pre; [intros ZERO; [apply triple_pure; [unfold Qloop; [cbn; [rewrite sepconj_emp; [intros h A; [exists l, p; [auto]]]]]]]]]]]]]]]]]]]]]]|unfold Qloop; [cbn; [red; [auto]]]]|unfold Qloop; [intros v h [A B]; [apply Z.eqb_neq in A; [rewrite A in B; [auto]]]]]]].
Qed.
