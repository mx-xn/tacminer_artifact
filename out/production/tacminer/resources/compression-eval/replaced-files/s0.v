...
Proof.
custom1 H a b e HA H0 u v; [split with u ( v - _i ); [auto with arith |auto |custom0; [auto | .. ] | .. ] | .. ].
Qed.

Lemma b_d : forall a b : nat, bezout a b -> bezout a (a + b)%nat.
Proof.
custom1 H a b e HA H0 u v; [split with ( u - v ) _i; [auto |auto with zarith |custom0; [now rewrite ( Zmult_comm v ( Z_of_nat b ) ) | .. ] | .. ] | .. ].
Qed.
