...
input_files = [f for f in os.listdir(script_directory) if f.endswith('.csv') and f.startswith('NeedDomain')]
...
output_file = os.path.join(script_directory, 'combined-NeedDomain.csv')
