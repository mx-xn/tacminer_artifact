...
Proof.
unfold inter , In; [custom0 s1 s2 x; [apply R.In_inter; [apply proj2_sig |apply proj2_sig | .. ] | .. ] | .. ].
Qed.
...
Proof.
unfold union , In; [custom0 s1 s2 x; [destruct ( R.Ins1oks2union  ( proj2sig  )  ( proj2sig  ) ); [generalize H0 x; [tauto | .. ]] | .. ] | .. ].
Qed.
