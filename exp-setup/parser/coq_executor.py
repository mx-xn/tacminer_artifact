...
class CoqExecutor:
    ...
    def __init__(self, project_root: str = None, main_file: str = None, use_hammer: bool = False, timeout_in_sec: int = 60,
        ...
        self.coq : coq_serapy.SerapiInstance = None
        self.execution_complete = False

    def __enter__(self):
        self._all_dep_handles = []
        self.coq = coq_serapy.SerapiInstance(["sertop", "--implicit"], None, self.project_root,
    ...
    def run_next(self) -> bool:
        ...
        try:
            ...
            print(f"Got an exception while running '{stmt}' on coq. File name: {self.main_file}")
            raise
        return True
