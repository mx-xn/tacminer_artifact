...
Ltac custom_tac27 H0 := intros; eapply H0.

Ltac custom_tac46 H0 H1 := apply H0; apply H1.

Ltac custom_tac37 H0 H1 := apply H0; intros H1.

Ltac custom_tac51 H0 H1 H2 H3 H4 H5 := apply H0; apply H1; intros H2; cbn; rewrite H3; apply H4; intros H5; subst H2.

Ltac custom_tac42 H0 := red; intros; exists H0; auto.

Ltac custom_tac41 H0 H1 := apply H0; rewrite H1.

Ltac custom_tac35  := red; auto.

Lemma triple_consume: forall R buff free busy,
  buffer_invariant R buff free busy ⊢
           ⦃ emp ⦄ CONSUME buff free busy ⦃ fun v => R v ⦄. Proof. intros. eapply triple_seq. unfold buffer_invariant. rewrite sepconj_comm. apply triple_frame_invariant. apply triple_acquire. apply triple_exists_pre. intros v. eapply triple_let. apply triple_frame. apply triple_get. intros v'. cbn. rewrite lift_pureconj. apply triple_simple_conj_pre. intros EQ; subst v'. apply triple_seq with (emp**R v). unfold buffer_invariant. apply triple_frame_invariant. apply triple_frame. eapply triple_consequence_pre. apply triple_release. apply valid_precise. red; intros; exists v; auto. apply triple_pure. rewrite sepconj_emp. red; auto. Qed.
