...
Proof. intros l1 l2 H1 H2. replace (open :: l1 ++ close :: l2) with ((open :: l1 ++ close :: nil) ++ l2). - apply wp_concat. custom_tac1 wp_encapsulate. trivial. - repeat (simpl in |- *; rewrite <- app_assoc); simpl in |- *. trivial. Qed.
...
Proof. simple induction t. - simpl; apply wp_nil. - simpl; intros t1 H1 t2 H2; custom_tac1 wp_o_head_c. Qed.
